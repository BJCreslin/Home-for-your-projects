          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('implementer')}>
                  Implementer <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {taskList.map((task, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{task.comment}</td>
                  <td>{task.status}</td>
                  <td>{task.created ? <TextFormat type="date" value={task.created} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{task.edited ? <TextFormat type="date" value={task.edited} format={APP_DATE_FORMAT} /> : null}</td>
