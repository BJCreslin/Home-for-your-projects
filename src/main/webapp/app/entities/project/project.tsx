          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('projectUrl')}>
                  Project Url <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {projectList.map((project, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{project.created ? <TextFormat type="date" value={project.created} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{project.edited ? <TextFormat type="date" value={project.edited} format={APP_DATE_FORMAT} /> : null}</td>
