            ...
            <tbody>
              {commentList.map((comment, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{comment.created ? <TextFormat type="date" value={comment.created} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{comment.edited ? <TextFormat type="date" value={comment.edited} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{comment.task ? <Link to={`task/${comment.task.id}`}>{comment.task.id}</Link> : ''}</td>
