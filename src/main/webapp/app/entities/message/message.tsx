          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('recepient')}>
                  Recepient <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {messageList.map((message, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{message.created ? <TextFormat type="date" value={message.created} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{message.edited ? <TextFormat type="date" value={message.edited} format={APP_DATE_FORMAT} /> : null}</td>
