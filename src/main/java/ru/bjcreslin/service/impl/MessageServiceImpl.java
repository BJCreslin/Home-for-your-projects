...
import ru.bjcreslin.service.MessageService;
        ...
        return messageRepository
            ...
            .map(
                existingMessage -> {
                    ...
                    if (message.getRecepient() != null) {
                        existingMessage.setRecepient(message.getRecepient());
                    }
                    ...
                    if (message.getEdited() != null) {
                        existingMessage.setEdited(message.getEdited());
                    }
