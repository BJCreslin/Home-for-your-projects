...
class CommentResourceIT {
    ...
    private static final CommentStatus DEFAULT_STATUS = CommentStatus.NEW;
    private static final CommentStatus UPDATED_STATUS = CommentStatus.POSTED;
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getEdited()).isEqualTo(DEFAULT_EDITED);
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.author(UPDATED_AUTHOR).text(UPDATED_TEXT).status(UPDATED_STATUS).created(UPDATED_CREATED).edited(UPDATED_EDITED);
        ...
        assertThat(testComment.getEdited()).isEqualTo(UPDATED_EDITED);
    }
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.author(UPDATED_AUTHOR).text(UPDATED_TEXT).status(UPDATED_STATUS).edited(UPDATED_EDITED);
